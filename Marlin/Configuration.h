...
#define STRING_CONFIG_H_AUTHOR "(Pipshag, Dual Titan)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 360, 400, 412 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (164)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (136)    // Y point for Z homing when homing all axes (G28).
#endif
