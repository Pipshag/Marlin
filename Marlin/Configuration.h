...
#define STRING_CONFIG_H_AUTHOR "(Pipshag, BigBox DualDirect Titan)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKi 49.68
  #define  DEFAULT_bedKd 324.57
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 360, 400, 406.3 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
  #define UBL_PROBE_PT_1_X 16       // These set the probe locations for when UBL does a 3-Point leveling
  #define UBL_PROBE_PT_1_Y 160      // of the mesh.
  #define UBL_PROBE_PT_2_X 16
  #define UBL_PROBE_PT_2_Y 38
  #define UBL_PROBE_PT_3_X 280
  #define UBL_PROBE_PT_3_Y 38
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (164)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT (136)    // Y point for Z homing when homing all axis (G28).
#endif
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { 80, 220, (Z_MIN_POS + 3)}
