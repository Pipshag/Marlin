...
#define CUSTOM_MACHINE_NAME "IDEX Bowden"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 360, 400, 417.5 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 6, 100 }
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT -44    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT 216    // Y point for Z homing when homing all axis (G28).
#endif
